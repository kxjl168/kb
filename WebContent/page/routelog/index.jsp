								...
								<div class="panel-body">
									...
									<div class="container">
										...
										<div class="row  form-group margin-bottom-5">
											...
											<div class=" col-md-6  col-xs-12  ">
												<div class="control-label padding-top-0 col-xs-4 col-md-4 col-lg-4 ">中转服务器ID：</div>
												<div class="col-md-6 col-xs-8 text-right ">
													<input type="text" class="form-control" id="proxyserver_id" ng-model="proxyserver_id" placeholder="">
										...
										<div class="row  form-group margin-bottom-5">
											...
											<div class=" col-md-6  col-xs-12  ">
												<div class="control-label padding-top-0 col-xs-4 col-md-4 col-lg-4">出口城市：</div>
												<div class="col-md-6 col-xs-8 text-right ">
