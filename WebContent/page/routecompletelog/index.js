...
function init() {
	...
	initmenu($("#menuul"),"page/routecompletelog/");
...
$("#cpType2").select2({
		...
		//	$scope.lastSecondID = $scope.etId;
			...
			var obj = new Object();
			obj.proxyserver_id = $scope.proxyserver_id;// "12345678";
			obj.routeid = $scope.routeid;// "12345678";
		
			
			obj.page = $scope.page;// 1;// "12345678";
			obj.rows = $scope.rows;// 10;// "12345678";
			SZUMWS(http + "translog/getRouteCompletelogList.action", JSON
