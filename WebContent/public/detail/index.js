...
$scope.getReplayList = function() {
					...
					obj.page = $scope.rpage;// 1;// "12345678";
					obj.rows = $scope.rrows;// 10;// "12345678";
					SZUMWS(
	...
	/*
									$scope.rtotal = json.total;
									$scope.rpageDataPre = [];
									$scope.rpageDataAft = [];
									$scope.rpageNum = Math.ceil($scope.rtotal
											/ $scope.rrows);
				...
				$scope.openKey = function(id, url, source, servcieid, appName,
						appType, AppUrl, AppProcess, NeddParam) {
