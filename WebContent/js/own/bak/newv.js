...
(function ($) {
    window.PassPortUtil = {
        ...
        logout: function (appLogoutUrl, appId, passportHost, isRedirect, cbUrl) {
            ...
            $.when($z.logoutAppOne(passportHost), $z.logoutAppThree(passportHost), $z.logoutAppGogoup(passportHost), $z.logoutProHellorf(passportHost), $z.logoutHellorfPre(passportHost), $z.logoutZDo(passportHost)).done($z.logoutServer(str)).fail(function () {
