...
<meta name="author" content="ZHANG JIE"> 
			...
			<title>MY-KxのBook,Welcome~欢迎访问Kx的个人站点</title>
...
<script src="../../js/own/loading.js"></script>
						...
						<script type="text/javascript" src="index.js"></script>
							<script type="text/javascript" src="m_index_own.js"></script>
						<script type="text/javascript" src="../../public/pright/pright_t_h.js"></script>
