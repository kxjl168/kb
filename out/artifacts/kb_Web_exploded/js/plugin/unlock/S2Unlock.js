		...
		bindEvent: function() {
			...
			function trantox(x)
			{
				...
				var sh=setInterval(function(){
					var curpostion=(x-speed*ticktime);
					if(curpostion<=0)
						{
						clearInterval(sh);
						sh=null
					...
					_this.slideBtn.style.transform = 'translate3d('+ curpostion +'px, 0, 0)';
					$(".nc_bg").css("width",curpostion+"px");
					ticktime++;
