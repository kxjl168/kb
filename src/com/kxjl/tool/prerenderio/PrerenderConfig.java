...
public class PrerenderConfig {
	...
	public List<String> getExtensionsToIgnore() {
		List<String> extensionsToIgnore = Lists.newArrayList(".woff2", ".js", ".json", ".css", ".xml", ".less", ".png",
				".jpg", ".jpeg", ".gif", ".pdf", ".doc", ".txt", ".ico", ".rss", ".zip", ".mp3", ".rar", ".exe", ".wmv",
	...
	public String getPrerenderServiceUrl() {
		String prerenderServiceUrl = config.get("prerenderServiceUrl");

		prerenderServiceUrl = ConfigReader.getInstance().getProperty("preurl", prerenderServiceUrl);
