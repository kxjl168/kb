...
public class ImageUtil {
	...
	public static void resize(File originalFile, File resizedFile) {
		...
		int newwidth = ConfigReader.getInstance().getIntProperty(
				"RESIZE_FILE_WIDTH", 1024);
		int quality = ConfigReader.getInstance().getIntProperty(
				"RESIZE_QUALITY", 70);

		try {
			resize(originalFile, resizedFile, newwidth,
					(float) ((float) quality / 100.0));
		} catch (IOException e) {
			System.out.println("pic resize failded!:"+e.getMessage());
		}
	}
	 ...
	 *            新的宽度
	 * @param quality
	 *            图片质量参数 0.7f 相当于70%质量 2015年12月11日
	 */
	public static void resize(File originalFile, File resizedFile,
	...
	public static void main(String[] args) throws IOException {
		...
		File originalImage = new File("F:\\IMG\\2015\\banner1.jpeg");
		...
		File resizedImg1 = new File("F:\\IMG\\2015\\banner2.jpeg");
		resize(originalImage, resizedImg1, 1024, 0.7f);
