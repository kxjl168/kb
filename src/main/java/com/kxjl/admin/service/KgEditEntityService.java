...
*/
public interface KgEditEntityService {
     ...
     * @return
     */
	WZResponseEntity<?>  add(LoginUser user,KgEditEntity kgEditEntity) ;
     ...
     * @return
     */
	WZResponseEntity<?>  modify(LoginUser user,KgEditEntity kgEditEntity);
