 ...
 * @author Generator
 */
@Service("kgPropertyDatatypeService")
public class KgPropertyDatatypeServiceImpl implements KgPropertyDatatypeService {
     ...
     */
    @Transactional
    public Boolean add(KgPropertyDatatype kgPropertyDatatype) {
        return kgPropertyDatatypeMapper.insertSelective(kgPropertyDatatype) > 0;
	}
     ...
     */
    @Transactional
    public Boolean modify(KgPropertyDatatype kgPropertyDatatype) {
		return kgPropertyDatatypeMapper.updateByPrimaryKeySelective(kgPropertyDatatype) > 0;
	}
	...
	public Boolean delete(String id,String version) {
    	KgPropertyDatatypeKey key=new KgPropertyDatatypeKey();
    	key.setId(id);
    	key.setVersionId(version);
		return kgPropertyDatatypeMapper.deleteByPrimaryKey(key) > 0;
	}
    ...
    public KgPropertyDatatype getOne(String id,String version) {
    	KgPropertyDatatypeKey key=new KgPropertyDatatypeKey();
    	key.setId(id);
    	key.setVersionId(version);
		return kgPropertyDatatypeMapper.selectByPrimaryKey(key);
	}
     ...
     */
    @Transactional(readOnly = true)
    public List<KgPropertyDatatype> getAll() {
         KgPropertyDatatypeExample example = new KgPropertyDatatypeExample();
         return kgPropertyDatatypeMapper.selectByExample(example);
	}
    ...
    /**
   	 ...
   	 * @date 2020年6月9日
   	 */
   	public Page<KgPropertyDatatype> selectList(KgPropertyDatatype query, Pagination pageCondition) {
   		com.github.pagehelper.Page pageinfo = PageUtil.getPage(pageCondition);

   		List<KgPropertyDatatype> lst = kgPropertyDatatypeMapper.selectList(query);

   		Page<KgPropertyDatatype> page = new Page<KgPropertyDatatype>();
   		page.setResults(lst);
