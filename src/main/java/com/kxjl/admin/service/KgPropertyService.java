...
*/
public interface KgPropertyService {
     ...
     * @return
     */
	WZResponseEntity<?> add(LoginUser user,KgProperty kgProperty) ;
     ...
     * @return
     */
	WZResponseEntity<?> modify(LoginUser user,KgProperty kgProperty);
     ...
     * @return
     */
     KgProperty getOne(String id, String versionId);
    ...
    /**
   	 ...
   	 * @date 2020年6月9日
   	 */
   	 Page<KgProperty> selectList(LoginUser user,KgProperty query, Pagination pageCondition); 
   	 
   	
	public WZResponseEntity<?> saveOrmodify(LoginUser user,KgProperty kgProperty) ;
	
	 /**
     * <p>query info by name</p>
     * @param id
     * @return
     */
     KgProperty getOneByName(String name, String versionId);
