...
*/
public interface KgEditSubGroupService {
     ...
     * @return
     */
     Boolean add(LoginUser user,KgEditSubGroup kgEditSubGroup) ;
     ...
     * @return
     */
     Boolean modify(LoginUser user,KgEditSubGroup kgEditSubGroup);
     ...
     * @return
     */
     KgEditSubGroup getOne(String id);
