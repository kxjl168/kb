...
*/
public interface KgDataAuditLogService {
     ...
     * @return
     */
     Boolean add(KgDataAuditLog kgDataAuditLog) ;
     ...
     * @return
     */
     Boolean modify(KgDataAuditLog kgDataAuditLog);
     ...
     * @return
     */
     KgDataAuditLog getOne(String id);
