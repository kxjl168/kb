...
*/
public interface KgEditRelationService {


    /**
     * <p>New Info</p>
     * @param kgEditRelation
     * @return
     */
	WZResponseEntity<?> add(LoginUser user,KgEditRelation kgEditRelation) ;
     ...
     * @return
     */
	WZResponseEntity<?> modify(LoginUser user,KgEditRelation kgEditRelation);
     ...
     * @return
     */
     KgEditRelation getOne(String id);
