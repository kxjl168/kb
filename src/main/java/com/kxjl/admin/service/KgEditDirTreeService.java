...
*/
public interface KgEditDirTreeService {
     ...
     * @return
     */
	WZResponseEntity<?> add(LoginUser user,KgEditDirTree kgEditDirTree) ;
     ...
     * @return
     */
	WZResponseEntity<?> modify(LoginUser user,KgEditDirTree kgEditDirTree);
     ...
     * @return
     */
     KgEditDirTree getOne(String id);
