...
*/
public interface KgObjectRelationService {
     ...
     * @return
     */
     Boolean add(KgObjectRelation kgObjectRelation) ;
     ...
     * @return
     */
     Boolean modify(KgObjectRelation kgObjectRelation);
     ...
     * @return
     */
     KgObjectRelation getOne(String id, String versionId);
