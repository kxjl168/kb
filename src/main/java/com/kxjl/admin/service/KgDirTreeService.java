...
*/
public interface KgDirTreeService {
     ...
     * @return
     */
	WZResponseEntity<?> add(@CurrentUser LoginUser user,KgDirTree kgDirTree) ;
     ...
     * @return
     */
	WZResponseEntity<?> modify(@CurrentUser LoginUser user,KgDirTree kgDirTree);
     ...
     * @return
     */
     Boolean delete(@CurrentUser LoginUser user,String id, String versionId);
     ...
     * @return
     */
     KgDirTree getOne(String id, String versionId);
    ...
    /**
  	 ...
  	 * @date 2020年6月9日
  	 */
  	 Page<KgDirTree> selectList(@CurrentUser LoginUser user,KgDirTree query, Pagination pageCondition) ;
      ...
      * @date 2020年6月18日
      */
     List<KgDirTree> getTreeData(LoginUser user,KgDirTree node);
