...
*/
public interface KgEditPropertyService {
     ...
     * @return
     */
	WZResponseEntity<?> add(LoginUser user, KgEditProperty kgEditProperty) ;
     ...
     * @return
     */
	WZResponseEntity modify(LoginUser user, KgEditProperty kgEditProperty);
     ...
     * @return
     */
     KgEditProperty getOne(String id);
