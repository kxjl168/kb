 ...
 */
@RestController
@RequestMapping("/kg/kg-edit-entity")
public class KgEditEntityController {  
    
    Logger logger=LoggerFactory.getLogger(KgEditEntityController.class);
	 ...
	 */
	@PostMapping("/add")
	public WZResponseEntity<?> add(@CurrentUser LoginUser user,@RequestBody KgEditEntity kgSubGroup) {
		logger.info("kg add kgSubGroup:{}", kgSubGroup);
		return new WZResponseEntity<>(kgEditEntityService.add(user,kgSubGroup));
	}
	 ...
	 */
	@PutMapping("/modify")
	public WZResponseEntity<?> modify(@CurrentUser LoginUser user,@RequestBody KgEditEntity kgSubGroup) {
		logger.info("kg modify kgSubGroup:{}", kgSubGroup);
		return new WZResponseEntity<>(kgEditEntityService.modify(user,kgSubGroup));
	}
	...
	public WZResponseEntity<?> delete(@CurrentUser LoginUser user,@PathVariable String id) {
		...
		return new WZResponseEntity<>(kgEditEntityService.delete(user,id));
	}
	 ...
	 */
	@GetMapping("/get/{id}")
	public WZResponseEntity<KgEditEntity> getOne(@PathVariable String id) {
		logger.info("kg get kgSubGroup:{}", id);
		KgEditEntity result = kgEditEntityService.getOne(id);
		if (result == null) {
