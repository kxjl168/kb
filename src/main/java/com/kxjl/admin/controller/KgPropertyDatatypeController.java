...
import com.kxjl.admin.service.KgPropertyDatatypeService;
 ...
 */
@RestController
@RequestMapping("/kg/kg-property-datatype")
public class KgPropertyDatatypeController {  
    
    Logger logger=LoggerFactory.getLogger(KgPropertyDatatypeController.class);

    /**
     * <p>BussinessService</p>
     */
    @Autowired
    KgPropertyDatatypeService kgPropertyService;
	 ...
	 */
	@PostMapping("/add")
	public WZResponseEntity<?> add(@RequestBody KgPropertyDatatype kgProperty) {
		logger.info("kg add kgProperty:{}", kgProperty);
		return new WZResponseEntity<>(kgPropertyService.add(kgProperty));
	}
	 ...
	 */
	@PutMapping("/modify")
	public WZResponseEntity<?> modify(@RequestBody KgPropertyDatatype kgProperty) {
		logger.info("kg modify kgProperty:{}", kgProperty);
		return new WZResponseEntity<>(kgPropertyService.modify(kgProperty));
	}
	...
	public WZResponseEntity<?> delete(@PathVariable String id) {
		...
		return new WZResponseEntity<>(kgPropertyService.delete(id,Constants.DEFULT_VERSION));
	}
	 ...
	 */
	@GetMapping("/get/{id}")
	public WZResponseEntity<KgPropertyDatatype> getOne(@PathVariable String id) {
		logger.info("kg get kgProperty:{}", id);
		KgPropertyDatatype result = kgPropertyService.getOne(id,Constants.DEFULT_VERSION);
		if (result == null) {
	...
	@RequestMapping("/list")
	@ResponseBody
	public WZResponseEntity<List<KgPropertyDatatype>> getListByPage( KgPropertyDatatype query, Pagination pageCondition) {
	//	System.out.println(pageCondition.getPageSize());
		Page<KgPropertyDatatype> result = kgPropertyService.selectList(query, pageCondition);
		WZResponseEntity<List<KgPropertyDatatype>> rst = new WZResponseEntity<>(result.getResults());
