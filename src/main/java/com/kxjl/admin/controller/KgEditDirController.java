 ...
 */
@RestController
@RequestMapping("/kg/kg-edit-dirtree")
public class KgEditDirController {  
    
    Logger logger=LoggerFactory.getLogger(KgEditDirController.class);

    /**
     * <p>BussinessService</p>
     */
    @Autowired
    KgEditDirTreeService kgSubGroupService;
	 ...
	 */
	@PostMapping("/add")
	public WZResponseEntity<?> add(@CurrentUser LoginUser user, KgEditDirTree kgSubGroup) {
	 ...
	 */
	@PutMapping("/modify")
	public WZResponseEntity<?> modify(@CurrentUser LoginUser user, KgEditDirTree kgSubGroup) {
	 ...
	 */
	@GetMapping("/get/{id}")
	public WZResponseEntity<KgEditDirTree> getOne(@PathVariable String id) {
		logger.info("kg get kgSubGroup:{}", id);
		KgEditDirTree result = kgSubGroupService.getOne(id);
		if (result == null) {
