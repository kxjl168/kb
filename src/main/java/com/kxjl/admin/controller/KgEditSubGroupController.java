 ...
 */
@RestController
@RequestMapping("/kg/kg-edit-sub-group")
public class KgEditSubGroupController {  
    
    Logger logger=LoggerFactory.getLogger(KgEditSubGroupController.class);

    /**
     * <p>BussinessService</p>
     */
    @Autowired
    KgEditSubGroupService kgSubGroupService;
	 ...
	 */
	@PostMapping("/add")
	public WZResponseEntity<?> add(@CurrentUser LoginUser user, KgEditSubGroup kgSubGroup) {
	 ...
	 */
	@PutMapping("/modify")
	public WZResponseEntity<?> modify(@CurrentUser LoginUser user, KgEditSubGroup kgSubGroup) {
	...
	public WZResponseEntity<?> delete(@CurrentUser LoginUser user,@PathVariable String id) {
		...
		return new WZResponseEntity<>(kgSubGroupService.delete(user,id));
	}
	...
	public WZResponseEntity<KgSubGroup> getOne(@PathVariable String id) {
		...
		KgEditSubGroup result = kgSubGroupService.getOne(id);
		if (result == null) {
