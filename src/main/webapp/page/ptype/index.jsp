...
<meta charset="UTF-8">
	<meta name="viewport"
		...
		<meta http-equiv="X-UA-Compatible" content="IE=edge">
			<title>概览</title> <!-- 			<link rel="stylesheet" type="text/css" media="screen" href="../../js/plugin/bootstrap/css/bootstrap.min.css">
...
<body>
						...
						<div class="panel-body">
							...
							<div class="">
								...
								<div class="row  form-group margin-bottom-5">
									...
									<div class="  col-md-6  col-xs-12  ">
										<div
											class="control-label padding-top-0 col-xs-4 col-md-3 col-lg-3">父分类：</div>
										<div class="col-md-6 col-xs-8 text-right ">
								...
								<div class="hide row  form-group margin-bottom-5">
									<div class=" col-md-6  col-xs-12 ">
										<div
											class="control-label padding-top-0 col-xs-4 col-md-3 col-lg-3">出口位置：</div>
										<div class="col-md-6 col-xs-8 text-right ">
											<input type="text" class="form-control" id="city"
												ng-model="city" placeholder="">
										</div>
									</div>
									...
									<div class=" col-md-6  col-xs-12 ">
										<div
											class="control-label padding-top-0 col-xs-4 col-md-3 col-lg-3 ">手机IP：</div>
										<div class="col-md-6 col-xs-8 text-right ">
											<input type="text" class="form-control" id="ip" ng-model="ip"
												placeholder="">
										</div>
									</div>
								</div>
						...
						<caption>
							...
							<div
								...
								<button type="button" ng-click="addOrModify()"
									class="btn btn-primary btn-add btn-block   ">新增类型</button>
							</div>
							<div
								class=" col-lg-2 col-md-2 col-xs-4 pull-right margin-bottom-10 padding-right-0 ">
								<button type="button" ng-click="getList()"
						...
						<tbody>
							...
							<tr ng-repeat="x in datalist">
								...
								<td><img style="max-width: 30px;"
									src="{{ x.val2 }}{{x.val1}}" class="img-responsive" /></td>

								<td class="">{{ x.dict_name }}</td>
								<td class="">{{ x.parent_name }}</td>
								<td class="" ng-bind-html="x.enable|fmt"></td>

								<td class="hide">{{ x.ip_refresh_interval }}</td>
								<td class="hide">
									<div class="popover-wrapper">
										<a href="#" editable-select="x.city"
											onbeforesave="checkcity($index,$data)"
											e-ng-options="s as s for s in citys_select"> <!--  s.value as s.text for -->
											{{ x.city|| "empty" }}
										</a>
									</div>
								...
								<td><a href="#" class="text-info" ng-click="addOrModify(x)">修改</a>
									<a href="#" class="text-warning" ng-click="del(x)">删除</a></td>
							</tr>
					...
					<div class="row" ng-show="selType==1">
						<div class="form-group col-xs-12">
							...
							<div class="col-xs-8 text-right">
								<select class="form-control" onchange="" ng-model="cpTypes"
									id="cpType" name="cpType">
								</select>
							</div>
						</div>
					</div>
						...
						<div class="form-group col-xs-12">
							...
							<div class="col-xs-8 text-center">
								<div class="info_value">
									<input type="radio" value="1" onclick="selectPublic(1)"
										name="IsPublic" ng-model="cp.IsPublic"
										ng-checked="cp.IsPublic=='1'">是 <input type="radio"
										value="0" onclick="selectPublic(0)" name="IsPublic"
										ng-model="cp.IsPublic" ng-checked="cp.IsPublic=='0'">否
					...
					<div class="row ">
						<form name="fm" id="fm"
							...
							*密码必须填写&nbsp;
								...
								<div class="form-group col-xs-12 row ">
									...
									<div class="col-xs-5 text-right ">
										...
										<input required readonly="readonly" class=" form-control"
											type="text" name="oldname" id="oldname" ng-model="oldname"
											placeholder=" "> <span
							...
							*密码必须填写&nbsp;
							...
							<div class="form-group col-xs-12 row">
								<div class="control-label padding-top-0 col-xs-4 ">级别：</div>

								<div class="col-xs-7 text-right">
									<select name="dict_level" class="form-control" id="dict_level">
							...
							<div class="form-group col-xs-12 row">
								<div class="control-label padding-top-0 col-xs-4 ">父分类：</div>
	...
	<script type="text/javascript"
		src="../../js/plugin/angular-xeditable-0.8.1/js/xeditable.js"></script>
	<script type="text/javascript"
