			...
			<div class="" id="content" style="">
				...
				<!-- <nav class="navbar navbar-default navbar-fixed-top navbar-inverse" role="navigation">
					<div class="navbar-header">
						...
						<a class="navbar-brand" href="#">用户账号管理</a>
					</div>
							...
							<table class="table">
								<caption>
									...
									<div class=" col-lg-2 col-md-2 col-xs-4 pull-right margin-bottom-10 padding-right-0 ">
										<button type="button" ng-click="addOrModify()" class="btn btn-primary btn-add btn-block   ">新增子账号</button>
									</div>
									<div class=" col-lg-2 col-md-2 col-xs-4 pull-right margin-bottom-10 padding-right-0 ">
			...
			<div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
				...
				<div class="row " >
					...
					<div class="form-group col-xs-12 row ">
							<div class="control-label padding-top-0 col-xs-4 ">用户账号：</div>
						...
						<div class="form-group col-xs-12 row ">
							<div class="control-label padding-top-0 col-xs-4 ">用户昵称：</div>
							<div class="col-xs-7 text-right ">
							 <input required  type="text" class="form-control " name="user_name" id="user_name" ng-model="user_name" placeholder=" ">
							 </div>
							 <div class="col-xs-12 col-xs-offset-4 row ">
							<!--  <span ng-show="fm.s_account.$error.required ">
							<span style="color:red " title="用户ID必须填写 ">
