...
<body>
		...
		<div class="col-xs-12 row">
			<div class="panel panel-success pshodow" >
				<div class="panel-heading" title="点击显示/隐藏查询条件"
					...
					aria-expanded="true">
					<div class="row">
						<h3 class="panel-title col-xs-4 col-lg-4 col-md-4 ">我的IP地址管理 - 查询条件</h3>
							...
							<div class="row  form-group margin-bottom-5">
								...
								<div class=" col-md-6  col-xs-12  ">
									...
									<div class="col-md-6 col-xs-8 text-right ">
										<input
											class="form-control ng-pristine ng-untouched ng-valid ng-empty"
											id="q_remark" type="text" name="q_remark"
											placeholder="">
									</div>
	...
	<script
		src="${basePath}/page/myip/myip.js"></script>
