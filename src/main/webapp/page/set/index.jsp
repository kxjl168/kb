		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body container margin-top-10 ">
					<div class="row ">
						<form name="fm" class="form-horizontal col-xs-12 col-lg-12 "
							...
							<input type="text " class="hide form-control " name="s_recordid"
								...
								<div class="hide form-group col-xs-12 row ">
									...
									<div class="col-xs-7 text-right ">
										<input required type="text" class="form-control"
											id="s_account" name="s_account" ng-model="s_account"
											placeholder="">
									</div>
								...
								<div class=" hide form-group col-xs-12 row ">
									...
									<div class="col-xs-7 text-right ">
										...
										<input required type="text" class="form-control"
											type="password " id="s_pass" name="s_pass" ng-model="s_pass"
											placeholder="">
									</div>
								...
								<div class=" hide form-group col-xs-12 row ">
									...
									<div class="col-xs-7 text-right ">
										<input type="text" class="form-control" id="name"
											ng-model="s_company" placeholder="">
									</div>
								</div>
								...
								<div class="form-group col-xs-12 row ">
									...
									<div class="col-xs-7 text-right ">
										<textarea type="text" class="form-control" id="name"
											ng-model="s_ip_desc" placeholder="">
								 </textarea>
								...
								<div class="form-group col-xs-12 row ">
									...
									<div class="col-xs-7 text-right ">
										<input required type="number" ng-patter="/^\d*$/" min="9"
											max="1000" class="form-control" id="name" name="s_ip_refresh"
											ng-model="s_ip_refresh" placeholder="">
									</div>
									<div class="col-xs-1 text-right ">
										<span ng-show="fm.s_ip_refresh.$error.required"> <span
											style="color: red" title="刷新周期必须填写"> <span
												class="glyphicon glyphicon-remove"></span>
										</span>
										</span> <span ng-show=" fm.s_ip_refresh.$invalid"> <span
											style="color: red" title="刷新周期为大于9的数字"> <span
												class="glyphicon glyphicon-remove"></span>
										</span>
										</span>
									</div>
