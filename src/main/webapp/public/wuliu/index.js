...
var createResultHtml = function(json, forceOrd) {
   ...
   +' </div> '
    ...
    html += '<div class="result-data wuliu ' + ord + '" border="0" cellspacing="0" width="100%">';
    var index = 0;
    var lastday,cday;
    for (var i = 0, l = json.data.length; i < l; i++) {
        ...
        html += '<div class="col-sm-2 col-xs-12 itime">' + cday + "</div>";
        html += '<div class="col-sm-1 ">' + ctime + "</div>";
        html += '<div class="col-2 lineparent"><span class="line">';
        	...
        	html+='</i></span></div>';
        html += '<div class="col-sm-8 col-xs-12" id="content-index-' + index + '">' + row.context + ad + "</div>";
        html += "</div>";
        index++;
    }
    html += "</div>";
