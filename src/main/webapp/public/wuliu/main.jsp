...
<%@ page language="java" contentType="text/html; charset=UTF-8"%>
	...
	<%@include file="/common/tag.jsp"%>
		...
		<head>
			...
			<title >快递查询-256kb.cn | 野生的喵喵 的个人站点 </title>
			
			<meta name="keywords" content="快递查询KxのBook">
	...
	<div class="c ">
				...
				<div class="panel panel-top panel-success">
							<div class="panel-heading" title="" data-toggle="collapse" data-parent="#accordion" href="#collapseOne">
								<div class="row">
									<h3 class="panel-title col-xs-10 ">输入快递单号：</h3>
								...
								<div class="panel-body">
									...
									<div class="container">
										...
										<div class="row  form-group margin-bottom-5">
											...
											<div class="control-label nopaddding padding-top-0 col-xs-4 col-sm-3  ">快递单号：</div>
												<div class="  col-sm-9 col-xs-8 text-right ">
													<input id="kwd" placeholder="快递单号"  name="kwd" ng-model="kwd" type="text" class=" form-control">
												</div>
											</div>		

											<div class=" col-sm-4  col-xs-12 nopaddding row mar margin-bottom-5">
											
											<div class="control-label nopaddding padding-top-0 col-xs-2 col-sm-3  hide " style="lline-height: 30px;">
					...
					<div class="col-xs-12" id="wuliuresult" style="min-height: 400px;">
